...
function createBaseMsgResetUnbondingRecordEpochNumbers(): MsgResetUnbondingRecordEpochNumbers {
  return {
    creator: ""
  };
}

export const MsgResetUnbondingRecordEpochNumbers = {
  encode(message: MsgResetUnbondingRecordEpochNumbers, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgResetUnbondingRecordEpochNumbers {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgResetUnbondingRecordEpochNumbers();
...
function createBaseMsgResetUnbondingRecordEpochNumbersResponse(): MsgResetUnbondingRecordEpochNumbersResponse {
  return {};
}

export const MsgResetUnbondingRecordEpochNumbersResponse = {
  encode(_: MsgResetUnbondingRecordEpochNumbersResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgResetUnbondingRecordEpochNumbersResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgResetUnbondingRecordEpochNumbersResponse();
